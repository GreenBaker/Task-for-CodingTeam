# Generated by Django 3.2.13 on 2022-06-23 16:47
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('additional', models.ManyToManyField(blank=True, related_name='additional_from', to='Foods.Food', verbose_name='Дополнительные товары')),
                ('category', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='food', to='Foods.foodcategory', verbose_name='Раздел меню')),
            ],
            options={
                'abstract': False,
            },
